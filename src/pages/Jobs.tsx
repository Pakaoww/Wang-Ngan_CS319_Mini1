  ...
  return (
    <section className="container page">
      <div className="page-heading">
        ...
        <p>Search opportunities in AI and digital technology.</p>
      </div>
      ...
      <p className="result-count">{visibleJobs.length} jobs found</p>
        ...
        {visibleJobs.map((job) => (
          <article className="job-item" key={job.title}>
            ...
            <div className="job-side">
              ...
              <button className="button small" onClick={() => onJobSelect(job)}>
                View Details
              </button>
            </div>
          </article>
