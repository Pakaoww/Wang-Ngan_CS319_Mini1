export type Job = { title: string; company: string; location: string; type: string; level: string; salary: string; skills: string[]; qualifications: string[]; description: string }

export const jobs: Job[] = [
  { title: 'AI Engineer', company: 'Vertex Labs', location: 'Bangkok', type: 'Full-time', level: 'Mid-level', salary: '$55k–72k', skills: ['Python', 'PyTorch', 'MLOps'], qualifications: ['ปริญญาตรีด้านวิทยาการคอมพิวเตอร์หรือสาขาที่เกี่ยวข้อง', 'มีประสบการณ์พัฒนาโมเดล Machine Learning', 'สามารถเขียนโปรแกรมภาษา Python ได้ดี'], description: 'Build intelligent products that help teams make better decisions.' },
  { title: 'Machine Learning Engineer', company: 'Northstar Digital', location: 'Remote', type: 'Full-time', level: 'Senior', salary: '$80k–105k', skills: ['TensorFlow', 'AWS', 'NLP'], qualifications: ['มีประสบการณ์ด้าน Machine Learning อย่างน้อย 3 ปี', 'มีความรู้ TensorFlow และการใช้งาน Cloud', 'สามารถออกแบบและนำระบบ ML ไปใช้งานจริงได้'], description: 'Ship production ML systems for millions of users.' },
  { title: 'Data Analyst', company: 'Lumen Commerce', location: 'Bangkok', type: 'Full-time', level: 'Entry-level', salary: '$32k–44k', skills: ['SQL', 'Tableau', 'Python'], qualifications: ['จบการศึกษาด้านสถิติ บริหารธุรกิจ หรือสาขาที่เกี่ยวข้อง', 'ใช้ SQL และเครื่องมือวิเคราะห์ข้อมูลได้', 'มีทักษะการสื่อสารและนำเสนอข้อมูล'], description: 'Turn customer data into the next great business insight.' },
  { title: 'Data Scientist', company: 'Cloudline', location: 'Singapore', type: 'Full-time', level: 'Mid-level', salary: '$60k–85k', skills: ['Python', 'Statistics', 'SQL'], qualifications: ['มีประสบการณ์ทำงานด้าน Data Science อย่างน้อย 2 ปี', 'มีพื้นฐานสถิติและการสร้าง Predictive Model', 'สามารถใช้ Python และ SQL ได้ดี'], description: 'Model the future of digital commerce with applied science.' },
  { title: 'Generative AI Developer', company: 'Morrow Studio', location: 'Remote', type: 'Contract', level: 'Mid-level', salary: '$50k–78k', skills: ['LLMs', 'TypeScript', 'RAG'], qualifications: ['มีประสบการณ์พัฒนาแอปพลิเคชันด้วย TypeScript', 'เข้าใจการทำงานของ LLM และระบบ RAG', 'สนใจเทคโนโลยี Generative AI และเรียนรู้สิ่งใหม่ได้เร็ว'], description: 'Create useful AI experiences from prototype to launch.' },
  { title: 'AI Product Specialist', company: 'Orbit Systems', location: 'Bangkok', type: 'Full-time', level: 'Senior', salary: '$68k–92k', skills: ['Product', 'AI Strategy', 'Research'], qualifications: ['มีประสบการณ์บริหารหรือพัฒนาผลิตภัณฑ์เทคโนโลยี', 'เข้าใจพื้นฐาน AI และการวิเคราะห์ความต้องการผู้ใช้', 'มีทักษะการวางแผนและประสานงานกับทีม'], description: 'Bridge product strategy and emerging technology.' },
]
